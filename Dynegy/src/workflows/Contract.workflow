...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>christopher.sill@dynegy.com.prod</recipient>
            <type>user</type>
        </recipients>
        <recipients>
        ...
        <recipients>
            <recipient>lauren.sciuto@dynegy.com.prod</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        ...
        <recipients>
            <recipient>katie.kiefer@dynegy.com.prod</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>lauren.matson@dynegy.com.uat</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>raymond.culver@dynegy.com.prod</recipient>
            <type>user</type>
        </recipients>
        <recipients>
